			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
					...
					<div
						...
						<a class="dropdown-item" href="./account/change-password"><i class="bi bi-key-fill"></i> Change Password</a
						>
	...
	<div class="container py-5">
		<nav class="nav nav-pills flex-column flex-sm-row mb-5">
			...
			<a
				...
				href="./editor-bin"
				>Editor Bin <span class="badge badge-light">{{ $count }}</span></a
			>
			@if($editor->roles == 3)
			<a
				class="flex-sm-fill text-sm-center nav-link"
							...
							<div class="row align-items-center mb-3">
								...
								<div class="col-auto">
									<button
										...
										onclick="setAssignFile('{{ $data['file'] }}', '{{ $data[0]['orderID'] }}', '{{ $editor->id}}')"
									>
										Assign
									</button>
								</div>
		...
		@else
			<!-- If no edit cases -->
			<h3 class="text-muted">No editing Cases</h3>
		@endif
	</div>
</main>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" onclick="editorAssign({{ $editor->id}})">Proceed</button>
			</div>
		</div>
	</div>
</div>
