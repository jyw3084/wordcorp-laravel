	...
	<div class="container py-5">
		<nav class="nav nav-pills flex-column flex-sm-row mb-5">
			<a
				...
				>Translator Bin <span class="badge badge-light">{{ $count }}</span></a
			>
			@if($user->roles == 3)
			<a
							...
							<div class="row">
								<div class="col-4">
									...
									<p><span>
										...
										@else
											{{ date('F d, Y h:ia', strtotime($data['deadline'])) }}
										@endisset
									</span></p>
								</div>
								<div class="col-4">
		...
		@else
			...
			<h3 class="text-muted">No translation Cases</h3>
		@endif
	</div>
</main>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="translatorAssignToMeBtn" onclick="translatorAssign({{ $user->id}})">Proceed</button>
			</div>
		</div>
	</div>
</div>
