	...
	<div class="container">
		<form id="msform">
			...
			<fieldset>
				...
				<p hidden id="trans_price" data-id="{{ trans('frontend.order.ntd.order_summary.price') }}"></p>
				...
				<input
					...
					value="{{ trans('frontend.order.back') }}"
				/>
				<input
					id='btn_next2'
					type="button"
					...
					value="{{ trans('frontend.order.next') }}"
				/>
			</fieldset>
			<fieldset>
				<div class="text-left mb-5">
					<h2>{{ trans('frontend.order.ntd.order_summary.tab_title') }}</h2>
					<p>{{ trans('frontend.order.ntd.order_summary.total') }}: <span id="span-total">X,XXX USD</span></p>
		...
		<script src="{{ asset('themes/default/assets/js/bs-custom-file-input.js') }}"></script>
