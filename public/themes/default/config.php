...
return array(
	...
	*/
	...
	'events' => array(
		...
		{
			$theme->setTitle('Wordcorp');
			$theme->setAuthor('Admin Wordccorp');
		},
		...
		'asset' => function($asset)
		{
			$asset->themePath()->add([
										['style', 'css/style.css'],
										['bootstrap-icons', 'css/bootstrap-icons/font/bootstrap-icons.css'],
										['sweet-alert', 'css/sweet-alert.css'],
										['user-dashboard', 'css/user-dashboard.css'],
										['jquery', 'js/dist/jquery.js'],
										['bootstrap-js', 'js/js/bootstrap.js'],
										['sweetalert-js', 'js/sweet-alert.min.js'],
										['jqueryform-js', 'js/jquery.form.js'],
										['validate-js', 'js/validation/jquery.validate.min.js'],
										['validate-additional-js', 'js/validation/jquery.additional-methods.min.js'],
										['script', 'js/script.js?'.date('YmdHis')]
									 ]);
